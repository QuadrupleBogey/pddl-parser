...
public class GripperPb4IT extends ProblemSuccessTester {
    ...
    @Test
    void gripperProblem1Has12Objects() {
    ...
    @Test
    void gripperProblem1HasObjectBall7() {
        assertTrue(problem.getObjects().contains(new ConstantDefinition("ball7")));
    }

    @Test
    void gripperProblem1HasObjectBall8() {
        assertTrue(problem.getObjects().contains(new ConstantDefinition("ball8")));
    }
    ...
    @Test
    void gripperProblem1Has23StateTerms() {
    ...
    @Test
    void gripperProblem1InitialStateHasBall7() {
        assertTrue(problem.getInitialStates().contains(predicate("ball", constant("ball7"))));
    }

    @Test
    void gripperProblem1InitialStateHasBall8() {
        assertTrue(problem.getInitialStates().contains(predicate("ball", constant("ball8"))));
    }
    ...
    @Test
    void gripperProblem1InitialStateHasAtBall7() {
        assertTrue(problem.getInitialStates().contains(predicate("at", constant("ball7"), constant("rooma"))));
    }

    @Test
    void gripperProblem1InitialStateHasAtBall8() {
        assertTrue(problem.getInitialStates().contains(predicate("at", constant("ball8"), constant("rooma"))));
    }
